...
$hash = '$S$EEv3if8vYWhQVza25Hrs5yjOm9zPAcUxR//O6d1oxxqGIEcpAnBP';
$password = 'password';

$alg = new PhpassHashedPassword(16);
$alg->check($password, $hash);
...
class PhpassHashedPassword {
  ...
  protected function crypt($algo, $password, $setting) {
    ...
    //print 'Count log2: ' . $count_log2 . PHP_EOL;
    ...
    //print base64_encode($hash) . PHP_EOL;
    do {
